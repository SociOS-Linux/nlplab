...
EXPECTED_SERVICE_ID = "nlplab.holmes.language-pilot"
EXPECTED_FUNCTION = "nlp"
...
def main() -> int:
    ...
    if manifest.get("function") != EXPECTED_FUNCTION:
        return fail("manifest function must be nlp")
    service = manifest.get("service", {})
    if service.get("id") != EXPECTED_SERVICE_ID:
        return fail("manifest service.id mismatch")
    if service.get("ownerRepository") != "SociOS-Linux/nlplab":
    ...
    print("OK: nlplab manifest and fixtures validated")
    return 0
