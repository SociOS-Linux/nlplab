...
def main() -> int:
    ...
    carry = {
        ...
        "carryId": "urn:srcos:model-carry:functional-service:nlplab-holmes-pilot",
        "displayName": "NLPLab Holmes Pilot Carry Profile",
        "service": {
            "id": service["id"],
            "ownerRepository": service["ownerRepository"],
            "function": manifest["function"],
            "manifestRef": "SociOS-Linux/nlplab:manifests/functional-service.json"
        },
        "sourceos": {
        ...
        "runtime": {
            ...
            "launchProfileRef": "urn:srcos:launch-profile:nlplab-holmes-pilot:disabled-v0",
        ...
        "evidence": {
            ...
            "smokeReceiptRef": "SociOS-Linux/nlplab:evidence/smoke-receipt.example.json"
        },
        "integrations": {
